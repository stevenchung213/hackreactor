...
identity      contains    invoke
first         every       sortBy
last          some        zip
each          extend      flatten
indexOf       defaults    intersection
filter        once        difference
reject        memoize     throttle
uniq          delay
map           shuffle
pluck         
reduce
...
(function() {
  ...
  _.filter = function(collection, trueOrFalse) {
    var result = [];
